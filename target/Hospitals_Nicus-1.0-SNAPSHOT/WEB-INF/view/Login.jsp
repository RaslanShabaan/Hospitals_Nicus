...
<h1 style="font-weight: bold;font-style: italic;color: #fff;font-size: 22px "> Client Search .... :) </h1>
<form  method="post" action="/UserSearch" style="border: 2px dashed #fff;width: 60%;margin-left: 20%">

    <h2 style="color: #d2322d;font-size: 20px"> Select Nicu Type :) </h2>
    <select id="start" name="NicuDesc" style="width: 50%;font-size: 15px">
        <option> Nicu Type </option>
    ...
    <h2  style="color: #d2322d;font-size: 20px"> Select Nicu Government :) </h2>
    <select id="startt" name="Govern" style="width: 50%;font-size: 15px">
...
<br><br><br>
    ...
    <button style="height:30%;background-color: #c7254e;color: #fff;font-size: 15px;font-style: italic;font-weight: bold;margin: auto;width: 40%"> Search ... </button>
