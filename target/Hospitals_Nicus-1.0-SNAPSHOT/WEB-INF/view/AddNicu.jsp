    ...
    <div class="content">
        <div class="content_resize">
            <div class="mainbar">
                ...
                <div class="article">
                    <h2><span> Insert </span> New Bed </h2>
                    <div class="clr"></div>

                    <form action="InsertNicu" method="post" >

                        <br>
                                <label>Nicu Id : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label>
                                <input  name="NicuId"  />
                   <br>     <br>
                                <label> Nicu Cost PerDay :</label>
                                <input name="NicuCost"  />
<br><br>
                                <select id="start" name="NicuDesc" style="width: 60%">
                        ...
                        <select id="start" name="NicuState" style="width: 60%">
                            <option>  Nicu State </option>
